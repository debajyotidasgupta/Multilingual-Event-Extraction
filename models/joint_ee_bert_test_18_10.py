...
def read_data(src_file, trg_file, pos_dev_file, datatype):
    ...
    data = get_data(src_lines, trg_lines, pos_lines, datatype)#call get_data()
...
class Encoder(nn.Module):
    ...
    def forward(self, words, bert_mask, pos_tag_seq, chars, pos_seq, is_training=False):
        ...
        words_input = torch.cat((word_input, pos_embeds, char_feature), -1)#[bs, max_seq_len, emb_dim=350]
...
class Decoder(nn.Module):
    def __init__(self, input_dim=300, hidden_dim=300, layers=1, drop_out_rate=0.3, max_length=23):
        ...
        self.et_lin = nn.Linear(9* self.input_dim, len(eventnameToIdx))#***************to identify the event type
...
class Seq2SeqModel(nn.Module):
    ...
    def forward(self, src_words_seq, bert_mask, pos_tag_seq, src_mask, src_char_seq, pos_seq, trg_words_seq, trg_rel_cnt,
        ...
        enc_hs = self.encoder(src_words_seq, bert_mask, pos_tag_seq, src_char_seq, pos_seq, is_training)#call encoder(): (bs, seq_len, hid_dim)
        #print(enc_hs.shape)
...
Sample = recordclass("Sample", "Id SrcLen SrcWords PosTags TrgLen TrgRels eventTypes argTypes TrgPointers")
...
train_data = read_data(src_train_file, trg_train_file, pos_train_file, 1)#call read_data() for train_set

src_dev_file = 'dev_bert.sent'
trg_dev_file = 'dev_bert.pointer'
pos_dev_file = 'dev_bert.pos'
dev_data = read_data(src_dev_file, trg_dev_file, pos_dev_file, 2)#call read_data() for dev_set

src_test_file = 'test_bert.sent'
trg_test_file = 'test_bert.pointer'
pos_test_file = 'test_bert.pos'
test_data = read_data(src_test_file, trg_test_file, pos_test_file, 3)#call read_data() for dev_set
...
model_file = '/home/alapan/joint_ee/5_10_21/model_pos.h5py'
