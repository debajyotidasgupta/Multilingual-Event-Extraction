...
def get_F1(data, preds):
    ...
    for i in range(0, len(data)):
        ...
        for gt_triple in gt_triples:
            ...
            if gt_triple[:3] in [pred[:3] for pred in pred_triples]:#eventphrase, eventtype, argphrase, argtype
                ai += 1
...
# vocab_file_name = './joint_ee/vocab.pkl'
...
sent_reader = open(src_test_file,'r')
